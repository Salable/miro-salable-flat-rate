if(!process.env.NEXT_PUBLIC_SALABLE_PRO_PLAN_UUID) throw new Error('Missing env SALABLE_PRO_PLAN_UUID')
...
if(!process.env.NEXT_PUBLIC_COOKIE_NAME) throw new Error('Missing env NEXT_PUBLIC_COOKIE_NAME')
...
export const cookieName = process.env.NEXT_PUBLIC_COOKIE_NAME
